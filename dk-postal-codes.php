<?php
/* =============================================================
   Foreningen Front Door — dk-postal-codes.php
   Coduri poștale daneze → oraș. Sursă: dataset comunitar
   (github.com/tjconcept/postal-codes-denmark), verificat manual pe
   câteva coduri cunoscute (2100, 8000, 5000...). Folosit ca sursă de
   adevăr server-side pentru complete-profile.php — orașul NU se ia
   niciodată din ce trimite clientul, doar din acest tabel, după codul
   poștal. Actualizare rară (codurile poștale daneze se schimbă foarte
   rar) — de revizuit anual dacă e nevoie.
   ============================================================= */
